...
func TestEncodeDecode(t *testing.T) {
	...
	for _, tt := range tests {
		url, err := tdexdconnect.EncodeToString(tt.scheme, tt.addr, tt.cert, tt.mac)
		require.NoError(t, err)
		require.Equal(t, tt.expectedURL, url)

		scheme, rpcAddr, certBytes, macBytes, err := tdexdconnect.Decode(url)
		require.NoError(t, err)

...
var (
	...
	ErrInvalidDerivationPathsLength = errors.New(
		"derivation paths must at least math the length of tx inputs",
	)
	...
	// ErrInvalidSatsPerBytes ...
	ErrInvalidSatsPerBytes = errors.New("unit of sats/bytes must be a non-zero positive number")
	...
	// ErrEmptyOutputs ...
	ErrEmptyOutputs = errors.New("outputs list must not be empty")

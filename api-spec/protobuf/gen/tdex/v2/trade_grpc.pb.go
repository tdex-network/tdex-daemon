...
const (
	TradeService_ListMarkets_FullMethodName      = "/tdex.v2.TradeService/ListMarkets"
	TradeService_GetMarketBalance_FullMethodName = "/tdex.v2.TradeService/GetMarketBalance"
	TradeService_GetMarketPrice_FullMethodName   = "/tdex.v2.TradeService/GetMarketPrice"
	TradeService_PreviewTrade_FullMethodName     = "/tdex.v2.TradeService/PreviewTrade"
	TradeService_ProposeTrade_FullMethodName     = "/tdex.v2.TradeService/ProposeTrade"
	TradeService_CompleteTrade_FullMethodName    = "/tdex.v2.TradeService/CompleteTrade"
)
...
func (c *tradeServiceClient) ListMarkets(ctx context.Context, in *ListMarketsRequest, opts ...grpc.CallOption) (*ListMarketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TradeService_ListMarkets_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tradeServiceClient) GetMarketBalance(ctx context.Context, in *GetMarketBalanceRequest, opts ...grpc.CallOption) (*GetMarketBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, TradeService_GetMarketBalance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tradeServiceClient) GetMarketPrice(ctx context.Context, in *GetMarketPriceRequest, opts ...grpc.CallOption) (*GetMarketPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, TradeService_GetMarketPrice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tradeServiceClient) PreviewTrade(ctx context.Context, in *PreviewTradeRequest, opts ...grpc.CallOption) (*PreviewTradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, TradeService_PreviewTrade_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tradeServiceClient) ProposeTrade(ctx context.Context, in *ProposeTradeRequest, opts ...grpc.CallOption) (*ProposeTradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, TradeService_ProposeTrade_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tradeServiceClient) CompleteTrade(ctx context.Context, in *CompleteTradeRequest, opts ...grpc.CallOption) (*CompleteTradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, TradeService_CompleteTrade_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

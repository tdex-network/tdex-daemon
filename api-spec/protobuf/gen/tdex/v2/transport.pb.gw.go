...
func RegisterTransportServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransportServiceServer) error {
	...
	mux.Handle("GET", pattern_TransportService_SupportedContentTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/tdex.v2.TransportService/SupportedContentTypes", runtime.WithHTTPPathPattern("/v2/transport"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TransportService_SupportedContentTypes_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_TransportService_SupportedContentTypes_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTransportServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransportServiceClient) error {
	...
	mux.Handle("GET", pattern_TransportService_SupportedContentTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/tdex.v2.TransportService/SupportedContentTypes", runtime.WithHTTPPathPattern("/v2/transport"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TransportService_SupportedContentTypes_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_TransportService_SupportedContentTypes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v2", "transport"}, ""))
)

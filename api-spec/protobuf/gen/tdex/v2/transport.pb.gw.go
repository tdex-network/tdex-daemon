...
func RegisterTransportServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransportServiceServer) error {
	...
	mux.Handle("GET", pattern_TransportService_SupportedContentTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/tdex.v2.TransportService/SupportedContentTypes", runtime.WithHTTPPathPattern("/v2/transport"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TransportService_SupportedContentTypes_0(rctx, inboundMarshaler, server, req, pathParams)
...
func RegisterTransportServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransportServiceClient) error {
	...
	mux.Handle("GET", pattern_TransportService_SupportedContentTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/tdex.v2.TransportService/SupportedContentTypes", runtime.WithHTTPPathPattern("/v2/transport"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TransportService_SupportedContentTypes_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return

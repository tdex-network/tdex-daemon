...
var file_tdex_v1_types_proto_rawDesc = []byte{
	...
	0x50, 0x45, 0x5f, 0x53, 0x45, 0x4c, 0x4c, 0x10, 0x01, 0x42, 0xa0, 0x01, 0x0a, 0x0b, 0x63, 0x6f,
	0x6d, 0x2e, 0x74, 0x64, 0x65, 0x78, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73,
...
var file_tdex_v1_types_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_tdex_v1_types_proto_goTypes = []interface{}{
	...
	(*Fee)(nil),            // 1: tdex.v1.Fee
	(*Fixed)(nil),          // 2: tdex.v1.Fixed
	(*Balance)(nil),        // 3: tdex.v1.Balance
	(*BalanceWithFee)(nil), // 4: tdex.v1.BalanceWithFee
	(*Market)(nil),         // 5: tdex.v1.Market
	(*MarketWithFee)(nil),  // 6: tdex.v1.MarketWithFee
	(*Price)(nil),          // 7: tdex.v1.Price
	(*Preview)(nil),        // 8: tdex.v1.Preview
}
var file_tdex_v1_types_proto_depIdxs = []int32{
	2, // 0: tdex.v1.Fee.fixed:type_name -> tdex.v1.Fixed
	3, // 1: tdex.v1.BalanceWithFee.balance:type_name -> tdex.v1.Balance
	1, // 2: tdex.v1.BalanceWithFee.fee:type_name -> tdex.v1.Fee
	5, // 3: tdex.v1.MarketWithFee.market:type_name -> tdex.v1.Market
	1, // 4: tdex.v1.MarketWithFee.fee:type_name -> tdex.v1.Fee
	7, // 5: tdex.v1.Preview.price:type_name -> tdex.v1.Price
	1, // 6: tdex.v1.Preview.fee:type_name -> tdex.v1.Fee
	3, // 7: tdex.v1.Preview.balance:type_name -> tdex.v1.Balance

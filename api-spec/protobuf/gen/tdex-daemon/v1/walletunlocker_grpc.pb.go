...
const (
	WalletUnlockerService_GenSeed_FullMethodName        = "/tdex_daemon.v1.WalletUnlockerService/GenSeed"
	WalletUnlockerService_InitWallet_FullMethodName     = "/tdex_daemon.v1.WalletUnlockerService/InitWallet"
	WalletUnlockerService_UnlockWallet_FullMethodName   = "/tdex_daemon.v1.WalletUnlockerService/UnlockWallet"
	WalletUnlockerService_ChangePassword_FullMethodName = "/tdex_daemon.v1.WalletUnlockerService/ChangePassword"
	WalletUnlockerService_IsReady_FullMethodName        = "/tdex_daemon.v1.WalletUnlockerService/IsReady"
)
...
func (c *walletUnlockerServiceClient) GenSeed(ctx context.Context, in *GenSeedRequest, opts ...grpc.CallOption) (*GenSeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, WalletUnlockerService_GenSeed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletUnlockerServiceClient) InitWallet(ctx context.Context, in *InitWalletRequest, opts ...grpc.CallOption) (WalletUnlockerService_InitWalletClient, error) {
	stream, err := c.cc.NewStream(ctx, &WalletUnlockerService_ServiceDesc.Streams[0], WalletUnlockerService_InitWallet_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *walletUnlockerServiceClient) UnlockWallet(ctx context.Context, in *UnlockWalletRequest, opts ...grpc.CallOption) (*UnlockWalletResponse, error) {
	...
	err := c.cc.Invoke(ctx, WalletUnlockerService_UnlockWallet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletUnlockerServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*ChangePasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, WalletUnlockerService_ChangePassword_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *walletUnlockerServiceClient) IsReady(ctx context.Context, in *IsReadyRequest, opts ...grpc.CallOption) (*IsReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, WalletUnlockerService_IsReady_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WalletUnlockerService_GenSeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletUnlockerService_GenSeed_FullMethodName,
	}
...
func _WalletUnlockerService_UnlockWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletUnlockerService_UnlockWallet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WalletUnlockerService_ChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletUnlockerService_ChangePassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WalletUnlockerService_IsReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WalletUnlockerService_IsReady_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

...
var file_tdex_daemon_v2_operator_proto_rawDesc = []byte{
	...
	0x22, 0xa1, 0x01, 0x0a, 0x10, 0x4e, 0x65, 0x77, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x52, 0x65,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x22, 0x13, 0x0a, 0x11, 0x4e, 0x65, 0x77, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	...
	,
	...
	0x64, 0x52, 0x05, 0x66, 0x69, 0x78, 0x65, 0x64, 0x22, 0x5e, 0x0a, 0x1c, 0x55, 0x70, 0x64, 0x61,
	...
	0x0b, 0x32, 0x16, 0x2e, 0x74, 0x64, 0x65, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x61, 0x72, 0x6b,
...
var file_tdex_daemon_v2_operator_proto_depIdxs = []int32{
	...
	76, // 21: tdex_daemon.v2.UpdateMarketAssetsPrecisionRequest.market:type_name -> tdex.v1.Market
	76, // 22: tdex_daemon.v2.UpdateMarketPriceRequest.market:type_name -> tdex.v1.Market
	83, // 23: tdex_daemon.v2.UpdateMarketPriceRequest.price:type_name -> tdex.v1.Price
	76, // 24: tdex_daemon.v2.UpdateMarketStrategyRequest.market:type_name -> tdex.v1.Market
	84, // 25: tdex_daemon.v2.UpdateMarketStrategyRequest.strategy_type:type_name -> tdex_daemon.v2.StrategyType
	72, // 26: tdex_daemon.v2.GetFeeFragmenterBalanceResponse.balance:type_name -> tdex_daemon.v2.GetFeeFragmenterBalanceResponse.BalanceEntry
	75, // 27: tdex_daemon.v2.WithdrawFeeFragmenterRequest.outputs:type_name -> tdex_daemon.v2.TxOutput
	73, // 28: tdex_daemon.v2.GetMarketFragmenterBalanceResponse.balance:type_name -> tdex_daemon.v2.GetMarketFragmenterBalanceResponse.BalanceEntry
	76, // 29: tdex_daemon.v2.MarketFragmenterSplitFundsRequest.market:type_name -> tdex.v1.Market
	75, // 30: tdex_daemon.v2.WithdrawMarketFragmenterRequest.outputs:type_name -> tdex_daemon.v2.TxOutput
	77, // 31: tdex_daemon.v2.ListMarketsResponse.markets:type_name -> tdex_daemon.v2.MarketInfo
	76, // 32: tdex_daemon.v2.ListTradesRequest.market:type_name -> tdex.v1.Market
	85, // 33: tdex_daemon.v2.ListTradesRequest.page:type_name -> tdex_daemon.v2.Page
	86, // 34: tdex_daemon.v2.ListTradesResponse.trades:type_name -> tdex_daemon.v2.TradeInfo
	85, // 35: tdex_daemon.v2.ListUtxosRequest.page:type_name -> tdex_daemon.v2.Page
	87, // 36: tdex_daemon.v2.ListUtxosResponse.spendable_utxos:type_name -> tdex_daemon.v2.UtxoInfo
	87, // 37: tdex_daemon.v2.ListUtxosResponse.locked_utxos:type_name -> tdex_daemon.v2.UtxoInfo
	88, // 38: tdex_daemon.v2.AddWebhookRequest.action:type_name -> tdex_daemon.v2.ActionType
	88, // 39: tdex_daemon.v2.ListWebhooksRequest.action:type_name -> tdex_daemon.v2.ActionType
	89, // 40: tdex_daemon.v2.ListWebhooksResponse.webhook_info:type_name -> tdex_daemon.v2.WebhookInfo
	85, // 41: tdex_daemon.v2.ListDepositsRequest.page:type_name -> tdex_daemon.v2.Page
	90, // 42: tdex_daemon.v2.ListDepositsResponse.deposits:type_name -> tdex_daemon.v2.Transaction
	85, // 43: tdex_daemon.v2.ListWithdrawalsRequest.page:type_name -> tdex_daemon.v2.Page
	90, // 44: tdex_daemon.v2.ListWithdrawalsResponse.withdrawals:type_name -> tdex_daemon.v2.Transaction
	74, // 45: tdex_daemon.v2.GetFeeFragmenterBalanceResponse.BalanceEntry.value:type_name -> tdex_daemon.v2.Balance
	74, // 46: tdex_daemon.v2.GetMarketFragmenterBalanceResponse.BalanceEntry.value:type_name -> tdex_daemon.v2.Balance
	0,  // 47: tdex_daemon.v2.OperatorService.DeriveFeeAddresses:input_type -> tdex_daemon.v2.DeriveFeeAddressesRequest
	2,  // 48: tdex_daemon.v2.OperatorService.ListFeeAddresses:input_type -> tdex_daemon.v2.ListFeeAddressesRequest
	4,  // 49: tdex_daemon.v2.OperatorService.GetFeeBalance:input_type -> tdex_daemon.v2.GetFeeBalanceRequest
	6,  // 50: tdex_daemon.v2.OperatorService.WithdrawFee:input_type -> tdex_daemon.v2.WithdrawFeeRequest
	8,  // 51: tdex_daemon.v2.OperatorService.NewMarket:input_type -> tdex_daemon.v2.NewMarketRequest
	10, // 52: tdex_daemon.v2.OperatorService.GetMarketInfo:input_type -> tdex_daemon.v2.GetMarketInfoRequest
	12, // 53: tdex_daemon.v2.OperatorService.DeriveMarketAddresses:input_type -> tdex_daemon.v2.DeriveMarketAddressesRequest
	14, // 54: tdex_daemon.v2.OperatorService.ListMarketAddresses:input_type -> tdex_daemon.v2.ListMarketAddressesRequest
	16, // 55: tdex_daemon.v2.OperatorService.OpenMarket:input_type -> tdex_daemon.v2.OpenMarketRequest
	18, // 56: tdex_daemon.v2.OperatorService.CloseMarket:input_type -> tdex_daemon.v2.CloseMarketRequest
	20, // 57: tdex_daemon.v2.OperatorService.DropMarket:input_type -> tdex_daemon.v2.DropMarketRequest
	22, // 58: tdex_daemon.v2.OperatorService.WithdrawMarket:input_type -> tdex_daemon.v2.WithdrawMarketRequest
	24, // 59: tdex_daemon.v2.OperatorService.GetMarketReport:input_type -> tdex_daemon.v2.GetMarketReportRequest
	26, // 60: tdex_daemon.v2.OperatorService.UpdateMarketPercentageFee:input_type -> tdex_daemon.v2.UpdateMarketPercentageFeeRequest
	28, // 61: tdex_daemon.v2.OperatorService.UpdateMarketFixedFee:input_type -> tdex_daemon.v2.UpdateMarketFixedFeeRequest
	30, // 62: tdex_daemon.v2.OperatorService.UpdateMarketAssetsPrecision:input_type -> tdex_daemon.v2.UpdateMarketAssetsPrecisionRequest
	32, // 63: tdex_daemon.v2.OperatorService.UpdateMarketPrice:input_type -> tdex_daemon.v2.UpdateMarketPriceRequest
	34, // 64: tdex_daemon.v2.OperatorService.UpdateMarketStrategy:input_type -> tdex_daemon.v2.UpdateMarketStrategyRequest
	36, // 65: tdex_daemon.v2.OperatorService.DeriveFeeFragmenterAddresses:input_type -> tdex_daemon.v2.DeriveFeeFragmenterAddressesRequest
	38, // 66: tdex_daemon.v2.OperatorService.ListFeeFragmenterAddresses:input_type -> tdex_daemon.v2.ListFeeFragmenterAddressesRequest
	40, // 67: tdex_daemon.v2.OperatorService.GetFeeFragmenterBalance:input_type -> tdex_daemon.v2.GetFeeFragmenterBalanceRequest
	42, // 68: tdex_daemon.v2.OperatorService.FeeFragmenterSplitFunds:input_type -> tdex_daemon.v2.FeeFragmenterSplitFundsRequest
	44, // 69: tdex_daemon.v2.OperatorService.WithdrawFeeFragmenter:input_type -> tdex_daemon.v2.WithdrawFeeFragmenterRequest
	46, // 70: tdex_daemon.v2.OperatorService.DeriveMarketFragmenterAddresses:input_type -> tdex_daemon.v2.DeriveMarketFragmenterAddressesRequest
	48, // 71: tdex_daemon.v2.OperatorService.ListMarketFragmenterAddresses:input_type -> tdex_daemon.v2.ListMarketFragmenterAddressesRequest
	50, // 72: tdex_daemon.v2.OperatorService.GetMarketFragmenterBalance:input_type -> tdex_daemon.v2.GetMarketFragmenterBalanceRequest
	52, // 73: tdex_daemon.v2.OperatorService.MarketFragmenterSplitFunds:input_type -> tdex_daemon.v2.MarketFragmenterSplitFundsRequest
	54, // 74: tdex_daemon.v2.OperatorService.WithdrawMarketFragmenter:input_type -> tdex_daemon.v2.WithdrawMarketFragmenterRequest
	56, // 75: tdex_daemon.v2.OperatorService.ListMarkets:input_type -> tdex_daemon.v2.ListMarketsRequest
	58, // 76: tdex_daemon.v2.OperatorService.ListTrades:input_type -> tdex_daemon.v2.ListTradesRequest
	60, // 77: tdex_daemon.v2.OperatorService.ListUtxos:input_type -> tdex_daemon.v2.ListUtxosRequest
	62, // 78: tdex_daemon.v2.OperatorService.AddWebhook:input_type -> tdex_daemon.v2.AddWebhookRequest
	64, // 79: tdex_daemon.v2.OperatorService.RemoveWebhook:input_type -> tdex_daemon.v2.RemoveWebhookRequest
	66, // 80: tdex_daemon.v2.OperatorService.ListWebhooks:input_type -> tdex_daemon.v2.ListWebhooksRequest
	68, // 81: tdex_daemon.v2.OperatorService.ListDeposits:input_type -> tdex_daemon.v2.ListDepositsRequest
	70, // 82: tdex_daemon.v2.OperatorService.ListWithdrawals:input_type -> tdex_daemon.v2.ListWithdrawalsRequest
	1,  // 83: tdex_daemon.v2.OperatorService.DeriveFeeAddresses:output_type -> tdex_daemon.v2.DeriveFeeAddressesResponse
	3,  // 84: tdex_daemon.v2.OperatorService.ListFeeAddresses:output_type -> tdex_daemon.v2.ListFeeAddressesResponse
	5,  // 85: tdex_daemon.v2.OperatorService.GetFeeBalance:output_type -> tdex_daemon.v2.GetFeeBalanceResponse
	7,  // 86: tdex_daemon.v2.OperatorService.WithdrawFee:output_type -> tdex_daemon.v2.WithdrawFeeResponse
	9,  // 87: tdex_daemon.v2.OperatorService.NewMarket:output_type -> tdex_daemon.v2.NewMarketResponse
	11, // 88: tdex_daemon.v2.OperatorService.GetMarketInfo:output_type -> tdex_daemon.v2.GetMarketInfoResponse
	13, // 89: tdex_daemon.v2.OperatorService.DeriveMarketAddresses:output_type -> tdex_daemon.v2.DeriveMarketAddressesResponse
	15, // 90: tdex_daemon.v2.OperatorService.ListMarketAddresses:output_type -> tdex_daemon.v2.ListMarketAddressesResponse
	17, // 91: tdex_daemon.v2.OperatorService.OpenMarket:output_type -> tdex_daemon.v2.OpenMarketResponse
	19, // 92: tdex_daemon.v2.OperatorService.CloseMarket:output_type -> tdex_daemon.v2.CloseMarketResponse
	21, // 93: tdex_daemon.v2.OperatorService.DropMarket:output_type -> tdex_daemon.v2.DropMarketResponse
	23, // 94: tdex_daemon.v2.OperatorService.WithdrawMarket:output_type -> tdex_daemon.v2.WithdrawMarketResponse
	25, // 95: tdex_daemon.v2.OperatorService.GetMarketReport:output_type -> tdex_daemon.v2.GetMarketReportResponse
	27, // 96: tdex_daemon.v2.OperatorService.UpdateMarketPercentageFee:output_type -> tdex_daemon.v2.UpdateMarketPercentageFeeResponse
	29, // 97: tdex_daemon.v2.OperatorService.UpdateMarketFixedFee:output_type -> tdex_daemon.v2.UpdateMarketFixedFeeResponse
	31, // 98: tdex_daemon.v2.OperatorService.UpdateMarketAssetsPrecision:output_type -> tdex_daemon.v2.UpdateMarketAssetsPrecisionResponse
	33, // 99: tdex_daemon.v2.OperatorService.UpdateMarketPrice:output_type -> tdex_daemon.v2.UpdateMarketPriceResponse
	35, // 100: tdex_daemon.v2.OperatorService.UpdateMarketStrategy:output_type -> tdex_daemon.v2.UpdateMarketStrategyResponse
	37, // 101: tdex_daemon.v2.OperatorService.DeriveFeeFragmenterAddresses:output_type -> tdex_daemon.v2.DeriveFeeFragmenterAddressesResponse
	39, // 102: tdex_daemon.v2.OperatorService.ListFeeFragmenterAddresses:output_type -> tdex_daemon.v2.ListFeeFragmenterAddressesResponse
	41, // 103: tdex_daemon.v2.OperatorService.GetFeeFragmenterBalance:output_type -> tdex_daemon.v2.GetFeeFragmenterBalanceResponse
	43, // 104: tdex_daemon.v2.OperatorService.FeeFragmenterSplitFunds:output_type -> tdex_daemon.v2.FeeFragmenterSplitFundsResponse
	45, // 105: tdex_daemon.v2.OperatorService.WithdrawFeeFragmenter:output_type -> tdex_daemon.v2.WithdrawFeeFragmenterResponse
	47, // 106: tdex_daemon.v2.OperatorService.DeriveMarketFragmenterAddresses:output_type -> tdex_daemon.v2.DeriveMarketFragmenterAddressesResponse
	49, // 107: tdex_daemon.v2.OperatorService.ListMarketFragmenterAddresses:output_type -> tdex_daemon.v2.ListMarketFragmenterAddressesResponse
	51, // 108: tdex_daemon.v2.OperatorService.GetMarketFragmenterBalance:output_type -> tdex_daemon.v2.GetMarketFragmenterBalanceResponse
	53, // 109: tdex_daemon.v2.OperatorService.MarketFragmenterSplitFunds:output_type -> tdex_daemon.v2.MarketFragmenterSplitFundsResponse
	55, // 110: tdex_daemon.v2.OperatorService.WithdrawMarketFragmenter:output_type -> tdex_daemon.v2.WithdrawMarketFragmenterResponse
	57, // 111: tdex_daemon.v2.OperatorService.ListMarkets:output_type -> tdex_daemon.v2.ListMarketsResponse
	59, // 112: tdex_daemon.v2.OperatorService.ListTrades:output_type -> tdex_daemon.v2.ListTradesResponse
	61, // 113: tdex_daemon.v2.OperatorService.ListUtxos:output_type -> tdex_daemon.v2.ListUtxosResponse
	63, // 114: tdex_daemon.v2.OperatorService.AddWebhook:output_type -> tdex_daemon.v2.AddWebhookResponse
	65, // 115: tdex_daemon.v2.OperatorService.RemoveWebhook:output_type -> tdex_daemon.v2.RemoveWebhookResponse
	67, // 116: tdex_daemon.v2.OperatorService.ListWebhooks:output_type -> tdex_daemon.v2.ListWebhooksResponse
	69, // 117: tdex_daemon.v2.OperatorService.ListDeposits:output_type -> tdex_daemon.v2.ListDepositsResponse
	71, // 118: tdex_daemon.v2.OperatorService.ListWithdrawals:output_type -> tdex_daemon.v2.ListWithdrawalsResponse
